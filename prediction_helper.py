...
# from main import medical_history
...
def handle_scaling(age,df) :
    ...
    df[cols_to_scale] = scaler.transform(df[cols_to_scale])  # scaler object expects 'income_level' column so we hv just added it as None but we actually know that it is of no use so that is why we are removing it.
